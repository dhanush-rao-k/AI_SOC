...
def main():
    ...
    if store.count() == 0:
        ...
        logs = [
            ...
            "Accepted password for deploy from 192.168.5.20 port 22 ssh2",
    ...
    # -------------------------------------------------
    # Test Log — Successful SSH Login
    # -------------------------------------------------

    log = (
        "Jul 22 02:33:17 prod-server sshd[9021]: "
        "Accepted password for deploy "
        "from 10.10.5.101 port 51234 ssh2 "
        "OpenSSH_8.9p1"
    )
